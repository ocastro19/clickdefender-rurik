	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				// Transaction Colors - Verde para vendas, Amarelo para upsell, Vermelho para reembolso
				transaction: {
					sales: 'hsl(var(--transaction-sales))',
					upsell: 'hsl(var(--transaction-upsell))',
					refund: 'hsl(var(--transaction-refund))'
				},
				chart: {
					'1': 'hsl(var(--chart-1))',
					'2': 'hsl(var(--chart-2))',
